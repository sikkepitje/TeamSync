...
* De logbestanden worden geroteerd ; de oudste wordt verwijderd, de nieuwste 9 blijven bewaard.
...
* LeerlingID's en docentID's worden geconverteerd naar onderkast. Omdat School
Data Sync TeacherID en StudentID hoofdlettergevoelig verwerkt, hebben
letterkastwijzigingen (is dat een woord?) in Magister geen verstoringen meer tot gevolg. 
...
* optie toevoegen om SIS ID te kapitaliseren, want SIS ID blijkt hoofdlettergevoelig, maar bestaande synchronisatie moet onveranderd doorgaan.