...
Try {
    ...
    ################# UITVOER
    Write-Log ("Samenstellen SDS bestanden ...")
...
Catch {
    ...
    "$(Get-Date -f "yyyy-MM-ddTHH:mm:ss:fff") [$logtag] caught exception: $e at line $line" | Out-File -FilePath $filename_log -Append
    Write-Error "caught exception: $e at line $line"      
}
