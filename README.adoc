...
In de datakladmap produceert `Transformeren-naar-SchoolDataSync` een aantal al dan niet makkelijk leesbare bestanden die inzicht geven in welke gegevens worden verwerkt door TeamSync en welke teams door School Data Sync aangemaakt zouden worden. 
